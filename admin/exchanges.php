...
$inputReput = (isset($_POST['inputReput'])) ? $_POST['inputReput'] : "" ;
$inputFees = (isset($_POST['inputFees'])) ? $_POST['inputFees'] : "" ;
$inputCountracc = (isset($_POST['inputCountracc'])) ? $_POST['inputCountracc'] : "" ;
$inputVerif = (isset($_POST['inputVerif'])) ? $_POST['inputVerif'] : "" ;
...
$inputReput_rus = (isset($_POST['inputReput_rus'])) ? $_POST['inputReput_rus'] : "" ;
...
$inputVerif_rus = (isset($_POST['inputVerif_rus'])) ? $_POST['inputVerif_rus'] : "" ;
$inputFees_rus = (isset($_POST['inputFees_rus'])) ? $_POST['inputFees_rus'] : "" ;
$inputCountracc_rus = (isset($_POST['inputCountracc_rus'])) ? $_POST['inputCountracc_rus'] : "" ;
//
...
switch  ($addeditdel) {
  ...
  $resinp = mysql_query("INSERT INTO exchanges (title, description, review, reputation, paymeth, fees, countracc, verification, pros1, pros2, pros3, cons1, cons2, cons3, description_rus, review_rus, reputation_rus, fees_rus, countracc_rus, verification_rus, pros1_rus, pros2_rus, pros3_rus, cons1_rus, cons2_rus, cons3_rus, file, url, metaTitle, metaDescription)
  VALUES ('$inputTitle', '$inputDescr','$inputText', '$inputReput', '$inputPaymeth', '$inputFees', '$inputCountracc', '$inputVerif', '$pros1', '$pros2', '$pros3', '$cons1', '$cons2', '$cons3', '$inputDescr_rus', '$inputText_rus', '$inputReput_rus', '$inputFees_rus', '$inputCountracc_rus', '$inputVerif_rus', '$pros1_rus', '$pros2_rus', '$pros3_rus', '$cons1_rus', '$cons2_rus', '$cons3_rus', ' $inputFile', '$inputUrl', '$inputMetaTitle', '$inputMetaDescription')");
 }
 ...
 header("Location: exchanges.php");
  break ;
    ...
    if ($inputFile == -1) {$resedit = mysql_query("UPDATE `exchanges` SET `title`='$inputTitle', `description`='$inputDescr', `review`='$inputText', `reputation`='$inputReput', `paymeth`='$inputPaymeth', `fees`='$inputFees', `countracc`='$inputCountracc',  `verification`='$inputVerif', `pros1`='$pros1', `pros2`='$pros2', `pros3`='$pros3', `cons1`='$cons1', `cons2`='$cons2', `cons3`='$cons3', `description_rus`='$inputDescr_rus', `review_rus`='$inputText_rus', `reputation_rus`='$inputReput_rus',
      `fees_rus`='$inputFees_rus', `countracc_rus`='$inputCountracc_rus', `verification_rus`='$inputVerif_rus', `pros1_rus`='$pros1_rus', `pros2_rus`='$pros2_rus', `pros3_rus`='$pros3_rus', `cons1_rus`='$cons1_rus', `cons2_rus`='$cons2_rus', `cons3_rus`='$cons3_rus', `url`='$inputUrl', `metaTitle`='$inputMetaTitle', `metaDescription`='$inputMetaDescription' WHERE `id`='$trimmed'");}
       else {$resedit = mysql_query("UPDATE `exchanges` SET `title`='$inputTitle', `description`='$inputDescr', `review`='$inputText', `reputation`='$inputReput', `paymeth`='$inputPaymeth', `fees`='$inputFees', `countracc`='$inputCountracc',  `verification`='$inputVerif', `pros1`='$pros1', `pros2`='$pros2', `pros3`='$pros3', `cons1`='$cons1', `cons2`='$cons2', `cons3`='$cons3', `description_rus`='$inputDescr_rus', `review_rus`='$inputText_rus', `reputation_rus`='$inputReput_rus',
        `fees_rus`='$inputFees_rus', `countracc_rus`='$inputCountracc_rus', `verification_rus`='$inputVerif_rus', `pros1_rus`='$pros1_rus', `pros2_rus`='$pros2_rus', `pros3_rus`='$pros3_rus', `cons1_rus`='$cons1_rus', `cons2_rus`='$cons2_rus', `cons3_rus`='$cons3_rus', `file`='$inputFile', `url`='$inputUrl', `metaTitle`='$inputMetaTitle', `metaDescription`='$inputMetaDescription' WHERE `id`='$trimmed'");}
      header("Location: exchanges.php");
    break ;
	case (3) :
    // Del news full
    $resDel = mysql_query("SELECT file FROM exchanges WHERE `id`='$trimmed'");
    if ($resDel) {
      ...
      $resdel = mysql_query("DELETE FROM exchanges WHERE `id`='$trimmed'");
      header("Location: exchanges.php");
		break ;
	}
      ...
      <div class="px-4">
        ...
        <table class="table table-hover table-responsive-md mb-0">
          ...
          <tbody>
            ...
            $result = mysql_query("SELECT * FROM exchanges WHERE 1 ORDER BY id DESC LIMIT $page1, 6") or die(mysql_error());
            ...
            <div class="form-group">
              ...
              <div class="form-group ">
                <div class="row">
                  <div class="col-md-5">
                    <div class="md-form">
                      <input placeholder=" "  class="form-control inputReput" name="inputReput" id="inputReput"type="text" >
                      <label for="inputReput">Reputation:
                        <span class="colortext">(*)</span>
                      </label>
                    </div>
                    <div class="md-form">
                      <input placeholder=" "class="form-control inputVerif" name="inputVerif" id="inputVerif" type="text">
                      <label for="inputVerif">Verification needed?:</label>
                    </div>
                  </div>
                  <div class="col-md-5 ml-auto">
                    <div class="md-form">
                      <input placeholder=" " class="form-control inputFees" name="inputFees" id="inputFees" type="text">
                      <label for="inputFees">Fees:
                        <span class="colortext">(*)</span>
                      </label>
                    </div>
                    <div class="md-form">
                      <input placeholder=" " class="form-control inputCountracc" name="inputCountracc" id="inputCountracc" type="text">
                      <label for="inputCountracc">Countries accepted:
                        <span class="colortext">(*)</span>
                      </label>
                    </div>
                  </div>
          ...
          <div class="form-group">
            ...
            <div class="form-group ">
                <div class="row">
                  <div class="col-md-5">
                    <div class="md-form">
                      <input placeholder=" "  class="form-control inputReput_rus" name="inputReput_rus" id="inputReput_rus" type="text" >
                      <label for="inputReput_rus">Репутация:
                        <span class="colortext">(*)</span>
                      </label>
                    </div>
                    <div class="md-form">
                      <input placeholder=" "class="form-control inputVerif_rus" name="inputVerif_rus" id="inputVerif_rus" type="text">
                      <label for="inputVerif_rus">Нужна проверка ?</label>
                    </div>
                  </div>
                  <div class="col-md-5 ml-auto">
                    <div class="md-form">
                      <input placeholder=" " class="form-control inputFees_rus" name="inputFees_rus" id="inputFees_rus" type="text">
                      <label for="inputFees_rus">Сборы::
                        <span class="colortext">(*)</span>
                      </label>
                    </div>
                    <div class="md-form">
                      <input placeholder=" " class="form-control inputCountracc_rus" name="inputCountracc_rus" id="inputCountracc_rus" type="text">
                      <label for="inputCountracc_rus">Принимающие страны:
                        <span class="colortext">(*)</span>
                      </label>
                    </div>
                  </div>
    ...
    $('.edit').on("click", function () {
      ...
      $.post("getdata.php", {
        ...
        function (data, status) {
          ...
          console.log(obj);
          $('#inputReput_rus').val(obj.reputation_rus);
          $('#inputDescr_rus').val(obj.description_rus);
          $('#inputVerif_rus').val(obj.verification_rus);
          $('#inputFees_rus').val(obj.fees_rus);
          $('#inputCountracc_rus').val(obj.countracc_rus);
          ...
          $('#inputReput').val(obj.reputation);
          $('#inputFees').val(obj.fees);
          $('#inputCountracc').val(obj.countracc);
          $('#inputVerif').val(obj.verification);
